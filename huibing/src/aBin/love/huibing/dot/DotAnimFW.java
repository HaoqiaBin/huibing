...
import aBin.love.huibing.fireview.Animation;
import aBin.love.huibing.R;
		...
		public void run()
		{
			...
			switch (random.nextInt(5))
			{
				case 0:
					...
					R.drawable.fw_01, R.drawable.fw_02,
					R.drawable.fw_03, R.drawable.fw_04, 
					R.drawable.fw_05, R.drawable.fw_06,
					R.drawable.fw_07, R.drawable.fw_08, 
					R.drawable.fw_09, R.drawable.fw_10, 
					R.drawable.fw_11, R.drawable.fw_12, 
					R.drawable.fw_13 },	false);
					break;

				case 1:
					mFWAnim = new Animation(mContext,new int[] {
					R.drawable.fw2_01, R.drawable.fw2_02,
				...
				case 3:
					mFWAnim = new Animation(mContext,new int[] {
					R.drawable.fw4_01, R.drawable.fw4_02,
				...
				case 4:
					mFWAnim = new Animation(mContext, new int[] {
					R.drawable.fw5_01, R.drawable.fw5_02,
